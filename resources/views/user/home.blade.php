          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="doctors.html">Professeurs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="blog.html">Nouvelles</a>
                        </li>
                        <li class="nav-item">
                         ...
                         @else
                        <li class="nav-item">
                            <a class="btn btn-primary ml-lg-3" href="{{route('login')}}">Connexion </a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-primary ml-lg-3" href="{{route('register')}}"> Inscription</a>
                        </li>
                        @endauth
                        @endif
                    </ul>
            ...
            <div class="row px-md-3">
                ...
                <div class="col-sm-6 col-lg-3 py-3">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="#">Join as Professor</a></li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg-3 py-3">
